...
void STC_FLASHMEM ConfigurationManager::setAccessPointParams(char const *SSID, char const *securityKey, uint8_t channel,
...
void STC_FLASHMEM ConfigurationManager::getAccessPointParams(char const **SSID, char const **securityKey,
                                                             uint8_t *channel, WiFi::SecurityProtocol *securityProtocol,
                                                             bool *hiddenSSID) {
...
void STC_FLASHMEM
    ConfigurationManager::setClientIPParams(bool staticIP, char const *IP, char const *netmask, char const *gateway) {
...
// IP, netmask, gateway valid only if staticIP = true
void STC_FLASHMEM ConfigurationManager::getClientIPParams(bool *staticIP, char const **IP, char const **netmask,
                                                          char const **gateway) {
...
void STC_FLASHMEM
    ConfigurationManager::setAccessPointIPParams(char const *IP, char const *netmask, char const *gateway) {
...
void STC_FLASHMEM
    ConfigurationManager::getAccessPointIPParams(char const **IP, char const **netmask, char const **gateway) {
...
void STC_FLASHMEM ConfigurationManager::setRouting(bool enabled) { FlashDictionary::setBool(STR_ROUTING, enabled); }
...
void STC_FLASHMEM
    ConfigurationManager::setUARTParams(uint32_t baudRate, bool enableSystemOutput, SerialService serialService) {
...
#if (FDV_INCLUDE_SERIALCONSOLE == 1)
SerialConsole *STC_FLASHMEM ConfigurationManager::getSerialConsole() { return s_serialConsole; }
#endif

#if (FDV_INCLUDE_SERIALBINARY == 1)
SerialBinary *STC_FLASHMEM ConfigurationManager::getSerialBinary() { return s_serialBinary; }
#endif

void STC_FLASHMEM
    ConfigurationManager::setGPIOParams(uint32_t gpioNum, bool configured, bool isOutput, bool pullUp, bool value) {
...
void STC_FLASHMEM ConfigurationManager::setDateTimeParams(int8_t timezoneHours, uint8_t timezoneMinutes,
                                                          char const *defaultNTPServer) {
...
void STC_FLASHMEM ConfigurationManager::getDateTimeParams(int8_t *timezoneHours, uint8_t *timezoneMinutes,
                                                          char const **defaultNTPServer) {
